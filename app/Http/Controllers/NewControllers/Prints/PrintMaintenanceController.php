...
class PrintMaintenanceController extends Fpdf
{
    ...
    function print(Request $request) {
        //$this->pdf->Image('../public/imagenes/documentos/com-1.jpg', '2', '2', '205', '280', 'JPG');
       ...
       $this->pdf->Image('../public/images/formato1.jpg', '2', '2', '205', '280', 'JPG');
        ...
        foreach ($search_image as $search_image) {
            ...
            if($document[1]!='pdf'){
               $this->pdf->Image('https://ares-path.s3.amazonaws.com/Items/' . $search_image->name_image, $row, 44, 48, 40);
               $this->pdf->Cell(4, 6, '', 0, 0);
                $row = $row + 48;
                $row++;
            }
        }
       ...
       $this->pdf->Cell(38, 6, '', 0, 0);
       $this->pdf->Cell(23, 3.2,  utf8_decode($name_materials), 0, 0); 
       $this->pdf->Ln(5.5);
       $this->pdf->SetFont('Arial', '', 7);
       $this->pdf->Cell(4, 6, '', 0, 0);
       $this->pdf->Cell(23, 3.2,  utf8_decode($search->code), 0, 0);

       $this->pdf->Ln(49.5);
       $this->pdf->SetFont('Arial', '', 7);
       $this->pdf->Cell(22, 6, '', 0, 0);
       $this->pdf->Cell(70, 3.2, $acquisition_date, 0, 0);
       $this->pdf->Cell(23, 3.2,  utf8_decode($search->name_provider), 0, 0);

       $this->pdf->Ln(8.7);
       $this->pdf->SetFont('Arial', '', 7);
       $this->pdf->Cell(20, 6, '', 0, 0);
        //$this->pdf->Cell(23, 3.2,  utf8_decode($service_provided), 0, 0);
        $y_item111 =$this->pdf->GetY();
       $this->pdf->MultiCell(150, 9, utf8_decode($service_provided), '', 'L', 0, 20);
        $y_item211 =$this->pdf->GetY();
        
       $this->pdf->SetFont('Arial', '', 7);
       $this->pdf->Cell(3, 6, '', 0, 0);
       $this->pdf->Cell(70, 3.2, $search->brand, 0, 0);
       $this->pdf->Cell(48, 6, '', 0, 0);
       ...
       $this->pdf->Cell(22, 3.2, $data_sheet, 0, 0);
       $this->pdf->Cell(23, 3.2, $handbook, 0, 0);

       $this->pdf->Ln(4.2);
       $this->pdf->SetFont('Arial', '', 7);
       $this->pdf->Cell(5, 6, '', 0, 0);
       $this->pdf->Cell(15, 3.2, $search->serie, 0, 0);
       ...
       $this->pdf->Ln($line2);
        foreach ($search_maintenance as $t) {
           ...
           $this->pdf->Cell(60, 3.2, $date_maintenance, 0, 0);
           $this->pdf->Cell(23, 3.2, $state_maintenance2, 0, 0);

           $this->pdf->Ln($line);
           $this->pdf->SetFont('Arial', '', 7);
           $this->pdf->Cell(62, 6, '', 0, 0);
           $this->pdf->Cell(17, 3.2, $state_maintenance1, 0, 0);
           $this->pdf->Cell(40, 3.2, $t->who, 0, 0);
           $this->pdf->Cell(45, 6, '', 0, 0);
           $this->pdf->Cell(23, 3.2, $t->support, 0, 0);
           $this->pdf->Ln(7);

           $this->pdf->Cell(1, 6, '', 0, 0);
            $y =$this->pdf->GetY();
           $this->pdf->MultiCell(150, 3, utf8_decode($t->observations_responsable), 0, 1);
            $y2 =$this->pdf->GetY();
            ...
            // $this->pdf->Cell(45, 6, $space.' y2 '.$y2.' y1 '. $y, 0, 0);
           $this->pdf->Ln($space);
    ...
    public function download(Request $request)
    {
       ...
       $this->pdf->Output("sdsadasd.pdf", "D");
    }
}
