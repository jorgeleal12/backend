...
class LoginController extends Controller
{
    ...
    public function load_rol(Request $request)
    {
        ...
        $search = DB::table('users')
            ...
            ->select('rol.idrol', 'rol_permission.idrol_permission', 'rol_permission.save', 'rol_permission.delete', 'rol_permission.edit', 'rol_permission.view', 'permission.idpermission as id')
            ->get();
